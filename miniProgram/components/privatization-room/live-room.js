const zegoSdk = require('../../js/jZego-wx-1.0.0.js');
let zego;
let playingList = [];
    ...
    start(zegotoken, authorToken) {
        ...
        if (this.checkParam()) {
            ...
            if (authorToken) {
                ...
                zego.login(zegotoken, () => {
                  console.log('login hall success');
                  zego.enterRoom(this.data.roomID, 1, loginSucCallback, loginFailCallback);
                }, err => {
