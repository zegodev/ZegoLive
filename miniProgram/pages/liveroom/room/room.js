...
Page({
  ...
  setPushUrl(url) {
    ...
    self.setData({
      ...
      self.data.pusherVideoContext.playBGM({
        url: 'https://zegodev.gitee.io/webrtcdemo-js/assets/bike.mp3?v='+new Date().getTime(),
        success: function () {
          console.log('playBGM suc');
          self.data.pusherVideoContext.stop();
          self.data.pusherVideoContext.start();
        },
        fail: function () {
          console.log('playBGM fail')
        },
        complete: function () {
          console.log('playBGM complete'); 
        }
      });
      // self.data.pusherVideoContext.setBGMVolume({
      //   volume:1,
      //   success: function () {
      //     console.log('setBGMVolume suc')
      //   },
      //   fail: function () {
      //     console.log('setBGMVolume fail')
      //   },
      //   complete: function () {
      //     console.log('setBGMVolume complete')
      //   }
      // })
  ...
  onBindbgmstart(detail){
    console.log('onBindbgmstart', detail)
  },
  onBindbgmprogress(detail) {
    console.log('onBindbgmprogress', detail)
  },
  onBindbgmcomplete(detail) {
    console.log('onBindbgmcomplete', detail)
  },
  error(e) {
